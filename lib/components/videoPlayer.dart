...
class _VideoPLayerState extends State<VideoPLayer> {
  @override
  void initState() {
    BlocProvider.of<VideoBloc>(context).add(PlayVideoEvent(url: widget.url));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider<VideoPlayerCubit>(
      ...
      child: Scaffold(
        ...
        body: BlocBuilder<VideoBloc, VideoStates>(builder: (context, state) {
            ...
            return Column(
              children: [
                ...
                ElevatedButton(
                  ...
                  child: BlocBuilder<VideoPlayerCubit, int>(
                    builder: (context, val) {
                      return Icon(state.controller.value.isPlaying
                          ? Icons.pause
                          : Icons.play_arrow);
                    },
                  ),
